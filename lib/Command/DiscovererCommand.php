...
class DiscovererCommand extends Command {
    ...
    protected function configure() {
        $this
            ->setName('vdirsyncerui:discover')
            ->setDescription('discover your calendars using vdirsyncer');
    }

    protected function execute(InputInterface $input, OutputInterface $output) {
        $this->syncerService->discover();
        return 0;
    }
